  ...
  <div id="app">
    <div class="sidenav" id="navBox" style="display:none;">
      <section class="section">
        <h1 class="title STYLE4">雷神开始加载。。</h1>
        <h1 class="title STYLE2">版本：4.5</h1> 
        <h1 class="title STYLE1">作者：尧</h1>
        <h1 class="title STYLE1">Q：377173877</h1>	
		<label class="label">更新内容:</label> 
		<span class="STYLE5">修复车辆跟随问题。</span>
        <div align="right">
